 ...
 *
 * Usage:
 *   bun scripts/install.ts link        Symlink both (development)
 *   bun scripts/install.ts copy        Copy both (stable deployment)
 *   bun scripts/install.ts uninstall   Remove both
 */
...
${dim("Usage:")}
  bun scripts/install.ts ${bold("link")}         Symlink both (development)
