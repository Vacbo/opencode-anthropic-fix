...
import { HealthScoreTracker, selectAccount, TokenBucketTracker } from "../../src/rotation.js";
...
describe("selectAccount", () => {
    ...
    /**
     * @param {Partial<import('../../src/rotation.js').AccountCandidate>} overrides
     * @returns {import('../../src/rotation.js').AccountCandidate}
     */
    ...
    it("falls back to first available for unknown strategy", () => {
        ...
        const result = selectAccount(
            candidates,
            "unknown" as unknown as Parameters<typeof selectAccount>[1],
            null,
            healthTracker,
            tokenTracker,
            0,
